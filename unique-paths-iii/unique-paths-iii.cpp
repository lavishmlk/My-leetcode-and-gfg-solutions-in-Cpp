...
int p=solution(starti,startj+1,grid,initialcount)+solution(starti+1,startj,grid,initialcount)+
    solution(starti,startj-1,grid,initialcount)+solution(starti-1,startj,grid,initialcount);
        initialcount++;
